...
export default function Navigate(){
    ...
    return (
        <nav className="flex flex-row text-white justify-between p-2 m-2 self-center-safe items-center align-middle sticky top-0 h-20 bg-[rgba(0,0,0,0.7)]">
            ...
            <div className="flex relative">
                ...
                {forNavs.map((navitem, i) => (
                <Link href={navitem.link} key={navitem.name}><li className="p-4 m-2 hover:border-b-2 hover:border-blue-400" key={navitem}>
                    {navitem.name}
                </li>
                </Link>
                ))}
